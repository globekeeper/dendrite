...
func Prepare(ctx context.Context, db DBTX) (*Queries, error) {
	q := Queries{db: db}
	var err error
	if q.deleteDataRetentionStmt, err = db.PrepareContext(ctx, deleteDataRetention); err != nil {
		return nil, fmt.Errorf("error preparing query DeleteDataRetention: %w", err)
	}
	...
	if q.selectDataRetentionsStmt, err = db.PrepareContext(ctx, selectDataRetentions); err != nil {
		return nil, fmt.Errorf("error preparing query SelectDataRetentions: %w", err)
	}
	...
	if q.upsertDataRetentionStmt, err = db.PrepareContext(ctx, upsertDataRetention); err != nil {
		return nil, fmt.Errorf("error preparing query UpsertDataRetention: %w", err)
	}
	return &q, nil
}
...
func (q *Queries) Close() error {
	var err error
	if q.deleteDataRetentionStmt != nil {
		if cerr := q.deleteDataRetentionStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing deleteDataRetentionStmt: %w", cerr)
		}
	}
	...
	if q.selectDataRetentionsStmt != nil {
		if cerr := q.selectDataRetentionsStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing selectDataRetentionsStmt: %w", cerr)
		}
	}
	...
	if q.upsertDataRetentionStmt != nil {
		if cerr := q.upsertDataRetentionStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing upsertDataRetentionStmt: %w", cerr)
		}
	}
	return err
}
...
type Queries struct {
	db                                      DBTX
	tx                                      *sql.Tx
	deleteDataRetentionStmt                 *sql.Stmt
...
func (q *Queries) WithTx(tx *sql.Tx) *Queries {
	return &Queries{
		db:                                      tx,
		tx:                                      tx,
		deleteDataRetentionStmt:                 q.deleteDataRetentionStmt,
