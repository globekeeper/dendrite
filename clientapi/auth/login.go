...
// is nil.
func LoginFromJSONReader(ctx context.Context, r io.Reader, useraccountAPI uapi.ClientUserAPI, cfg *config.ClientAPI) (*Login, LoginCleanupFunc, *util.JSONResponse) {
